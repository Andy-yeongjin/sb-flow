...
기능 설명 하나만 입력하면 SpecKit 설계 → SPEC_CONTEXT.md 브릿지 → bkit 구현(`/pdca do`)까지
**10단계를 자동으로 완주**합니다. 완료 후에는 사용자가 대화로 수정·개선합니다.
...
각 단계마다 `[N/10] 단계명 실행 중...` 형식으로 진행 상황을 보고합니다.
**멈추는 경우는 아래 두 가지뿐입니다:**
...
10단계 완료 후 아래 형식으로 최종 보고합니다:

```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✅ sb-oneshot 완료! (설계 → 구현 10단계)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
